...
public class ReflectiveTester {
  ...
  public static void main(final String[] args) {
    ...
    // Person{age=23.4,firstName=Joe,height=6.083,inARelationship=false,lastName=Schmoe,numberOfExes=2,numberOfFriends=3,thinksHeIsGreat=true,timesCried=100}
    log(
      ReflectiveToStringHelper.of(
        joe,
        Include.create().publics(true).privates(true).packages(true).protecteds(true),
